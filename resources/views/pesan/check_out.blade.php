                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style= "align : right">Rp. {{ number_format($pesanan_detail->barang->harga) }}</td>
                                <td style= "align : right">Rp. {{ number_format($pesanan_detail->jumlah_harga) }}</td>
                                <td>
                            ...
                            @endforeach
                            <tr>
                                <td colspan="5" style= "align : right"><strong>Total Harga :</strong></td>
                                <td style= "align : right"><strong>Rp. {{ number_format($pesanan->jumlah_harga) }}</strong></td>
                                <td>
